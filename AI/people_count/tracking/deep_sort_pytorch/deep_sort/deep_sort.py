...
#     def __init__(self, model_path, max_dist=0.2, min_confidence=0.3, nms_max_overlap=1.0, max_iou_distance=0.7, max_age=70, n_init=4, nn_budget=100, use_cuda=True):
...
#         bbox_tlwh[:,0]=bbox_tlwh[:,0]
#         bbox_tlwh[:,1]=bbox_tlwh[:,1]
...
# #         self.tracker.predict()
# #         self.tracker.update(detections)
# # 	    # self.tracker.update(detections,confidences)
# #
# #         # output bbox identities
# #         outputs = []
# #         # print("-----------------------------")
# #         for track in self.tracker.tracks:
# #             # if track.track_id in [8,11]:
# #             #     print("------------------@@@@@@",track.__dict__)
# #             if not track.is_confirmed() or track.time_since_update > 1:
# #                  continue
# #             box = track.to_tlwh()
...
# #                  n_init=4, nn_budget=100, use_cuda=True):
# #         self.min_confidence = min_confidence
# #         self.nms_max_overlap = nms_max_overlap
# #
# #         self.extractor = Extractor(model_path, use_cuda=use_cuda)
