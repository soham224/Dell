...
export function Builder() {
    ...
    // Define handler functions outside of JSX
    ...
    // Define the Formik render function outside of JSX
    const renderFormik = useCallback(({values, handleReset, handleSubmit, handleChange, handleBlur}) => (
        <>
    ...
    return (
        <>
            ...
            <Formik
                ...
                onReset={handleReset}
                children={renderFormik} // Use the render function
            />
        </>
    );
}
